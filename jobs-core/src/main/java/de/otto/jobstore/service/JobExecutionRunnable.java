    ...
    public void run() {
        ...
        try {
            ...
            if (jobRunnable.prepare(context)) {
                // add parameters coming from JobRunnable directly before execution, keep old ones!
                jobInfoRepository.appendParameters(context.getId(), jobRunnable.getParameters());
